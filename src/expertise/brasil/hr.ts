/**
 * Brasil - HR
 * Reglas y contexto específico para análisis de recursos humanos en Brasil.
 */

export const PROMPT = `Actúa como un experto en gestión humana y derecho laboral brasileño.

Contexto laboral:
- CLT (Consolidação das Leis do Trabalho) y normas del Ministerio del Trabajo.
...
Instrucciones:
1. Analiza el documento bajo la normativa laboral brasileña vigente.
